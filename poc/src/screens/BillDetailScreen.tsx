...
export const BillDetailScreen = () => {
  ...
  return (
    <div>
      ...
      <div className="px-5">
        <CardFace card={card} outstanding={bill.amount} />
      </div>

      <section className="mx-5 mt-5 rounded-3xl border border-paper-line bg-paper-raised/60 p-5">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3 text-[11px]">
          <div>
            <div className="text-[9px] uppercase tracking-[0.22em] text-ink-faint">gross</div>
            <Amount value={subtotal} signed={false} size="sm" className="mt-1" />
          </div>
          <div>
            <div className="text-[9px] uppercase tracking-[0.22em] text-ink-faint">credits</div>
      ...
      <section className="mx-5 mt-6 space-y-2">
        {!draftStripped && (
          ...
          >
            ...
            <span className="text-[10px] uppercase tracking-[0.22em] text-amber-glow">attach →</span>
          </motion.button>
        )}
        {!paid && (
          <motion.button
          ...
          >
            ...
            <span className="text-[10px] uppercase tracking-[0.22em] text-teal-400">confirm →</span>
          </motion.button>
        )}
        {paid && (
          <div className="flex items-center justify-between rounded-2xl border border-teal-400/30 bg-teal-400/[0.06] px-4 py-3 text-[11px]">
